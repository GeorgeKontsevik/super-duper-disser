...
def panel(x, y, w, h, title):
    ...
    d.text((x + 24, y + 22), title, font=F_H, fill=black)
...
d.text((50, 38), "Разложение сети на demand-supply, дорожные и транспортные слои", font=F_TITLE, fill=black)

panel(55, 125, 390, 700, "1. Сложная сеть")
panel(470, 125, 390, 700, "2. Supply-Demand слои")
...
d.text((100, 730), "demand / supply, дороги, транспорт", font=F, fill=black)
...
d.text((510, 395), "supply type A", font=F, fill=green)
...
d.text((1755, 600), "unpaved road", font=F, fill=brown)
damaged_graph(1755, 625, transports=TRANSPORT, broken=[("3", "8"), ("5", "8")])
d.text((1755, 795), "transport modes", font=F, fill=purple)
...
node((85, 900), "demand", r=20)
d.text((122, 880), "demand", font=F_LEGEND, fill=black)
node((275, 900), "supply", r=20)
d.text((312, 880), "supply", font=F_LEGEND, fill=black)
node((450, 900), "candidate", r=20)
d.text((487, 880), "mixed / transit", font=F_LEGEND, fill=black)
d.line((750, 900, 825, 900), fill=yellow, width=9)
d.text((845, 880), "paved", font=F_LEGEND, fill=black)
d.line((970, 900, 1045, 900), fill=brown, width=9)
d.text((1065, 880), "unpaved", font=F_LEGEND, fill=black)
d.line((1225, 900, 1300, 900), fill=red, width=9)
d.text((1320, 880), "aviation", font=F_LEGEND, fill=black)
d.line((1505, 900, 1580, 900), fill=purple, width=9)
